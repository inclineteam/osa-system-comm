...
const Profile = ({ auth, }) => {
    ...
    return (
        <PanelLayout headerTitle="Account Profile" defaultActiveLink="profile">
            <input type='file' accept='image/*' ref={inputElemRef} onChange={onSelectImage} className='d-none' />
            <TransparentModal show={showCropper} handleClose={() => setShowCropper(false)}>
                {
                    selectedImage && (
                        <>
                            <div className="controls">
                                <Button variant='dark' className='control' onClick={() => setShowCropper(false)}>
                                    <i className='bx bx-x fs-5'></i>
                                </Button>
                                <Button variant='l-green' className='control' onClick={onSubmitCrop}>
                        ...
                        <Form onSubmit={onSubmit}>
                            ...
                            <Row className='gy-3 align-items-end' >
                                ...
                                <Col lg>
                                    ...
                                    <button disabled={isUploading} className='btn btn-link text-decoration-none' type='button' onClick={() => setData('image', user.image)}>
                                        <small>Reset</small>
                                    </button>
                                    <Button disabled={isUploading} onClick={() => inputElemRef.current.click()} type='button' variant='light-primary' size='sm' className=' mb-1'>
                                        {
                            ...
                            </Row>
                            {
                                role === 'unit_head' && (
                                    <Row className='mt-1 gy-3'>
                                        <Col lg={4}>
                                            <Form.Label className='text-secondary text-sm'>Campus:</Form.Label>
                                            <Form.Control
                                                type='text'
                                        ...
                                        <Col lg={4}>
                                            <Form.Label className='text-secondary text-sm'>Classification:</Form.Label>
                                            <Form.Control
                                                type='text'
                                        ...
                                        <Col lg={4}>
                                            <Form.Label className='text-secondary text-sm'>Designation:</Form.Label>
                                            <Form.Control
                                                type='text'
                            ...
                            <div className="flex items-center justify-end gap-2 mb-3 mt-5">
                                <Button onClick={reset} variant='secondary'>
                                    <small><i className='bx bx-reset-alt'></i>Reset</small>
                                </Button>
                                <Button disabled={processing || isUploading} variant='primary' className='' type='submit'>
