          ...
          <tbody>
            {offices[officeItem].map((report) => (
              <>
                  ...
                  >
                    ...
                    <div className="max-w-6xl pt-8 w-full mx-auto">
                      ...
                      <p className="m-0 mt-1 font-semibold text-xl tracking-tight uppercase text-center">
                        LSPU{" "}
                        {auth.role === "admin" ? auth.user.campus.name : "all"}{" "}
                        Campus
                      </p>
                    </div>
                ...
                {totalReports === 0 ? (
                  <tr className="text-slate-500 border rounded-md border-dashed border-slate-200 py-8 text-center">
